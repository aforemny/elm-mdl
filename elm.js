...
var _debois$elm_mdl$Material_Table$defaultHeader = {string: '', nonNumeric: true, sorting: _elm_lang$core$Maybe$Nothing};
...
var _debois$elm_mdl$Material_Table$defaultCell = {string: '', nonNumeric: true};
	...
	return _debois$elm_mdl$Material_Options$set(
		function (config) {
			return _elm_lang$core$Native_Utils.update(
				config,
				{
					onDeselect: _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$html$Html_Events$on,
							'click',
...
var _debois$elm_mdl$Material_Table$onSelect = function (f) {
	return _debois$elm_mdl$Material_Options$set(
		function (config) {
			return _elm_lang$core$Native_Utils.update(
				config,
				{
					onSelect: _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$html$Html_Events$on,
							'click',
							_elm_lang$core$Json_Decode$succeed(
...
var _debois$elm_mdl$Material_Table$defaultConfig = {onClick: _elm_lang$core$Maybe$Nothing, onSelect: _elm_lang$core$Maybe$Nothing, onDeselect: _elm_lang$core$Maybe$Nothing};
var _debois$elm_mdl$Material_Table$Config = F3(
	function (a, b, c) {
		return {onClick: a, onSelect: b, onDeselect: c};
	});
...
var _debois$elm_mdl$Material_Table$Cell = F2(
	function (a, b) {
		return {string: a, nonNumeric: b};
	});
var _debois$elm_mdl$Material_Table$Header = F3(
	function (a, b, c) {
		return {string: a, nonNumeric: b, sorting: c};
	});
		...
		return function (_p0) {
			...
			function () {
				...
				if (_p2.ctor === 'Click') {
					...
					var _p3 = _p10;
					if (_p3.ctor === 'Change') {
						var _p4 = A2(_elm_lang$core$Debug$log, 'fwdChange', _p10);
						var _p5 = _p11;
						if (_p5.ctor === 'Just') {
							var _p7 = _p5._0;
		...
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_debois$elm_mdl$Material_Options$cs('is-upgraded'),
					A2(_debois$elm_mdl$Material_Table$cs$, 'mdl-data-table--selectable', true),
...
var _debois$elm_mdl$Demo_Tables$model = {mdl: _debois$elm_mdl$Material$model, sort: _debois$elm_mdl$Material_Table$Ascending};
		...
		if (_p0.ctor === 'Click') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						sort: _debois$elm_mdl$Material_Table$toggle(model.sort)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$core$Native_Utils.eq(
								A2(_elm_lang$core$Debug$log, 'sort', model.sort),
								_debois$elm_mdl$Material_Table$Ascending) ? _debois$elm_mdl$Material_Table$ascending : _debois$elm_mdl$Material_Table$descending
							])),
						A2(
						_debois$elm_mdl$Material_Table$header,
						'Quantity',
